...
function startRecording() {
    ...
    if (!stream) {
        showNotification('Caméra non disponible', 'error');
        return;
    }
    ...
    mediaRecorder.onstop = () => {
        ...
        currentVideoFile = new File([blob], 'enregistrement.webm', {
            type: 'video/webm',
            lastModified: Date.now()
        });
        ...
        document.getElementById('videoFileInfo').innerHTML = `
            ...
            <span>enregistrement.webm - video/webm</span>
        `;
    ...
    // Mettre à jour l'interface
    document.getElementById('recordBtn').innerHTML = '<i class="fas fa-circle"></i> Enregistrement...';
    ...
    recordingTimer = setInterval(() => {
        seconds++;
        document.getElementById('recordBtn').innerHTML = `<i class="fas fa-circle"></i> ${formatTime(seconds)}`;
    }, 1000);
